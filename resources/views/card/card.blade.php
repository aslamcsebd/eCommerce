            ...
            <div class="col-12">
               <div class="card mt-4 ">
                   ...
                   <div class="card-body">
                     ...
                     <div class="row">
                        <div class="col"></div>
                        <div class="col"><a class="btn btn-success" href="{{ '/' }}">Continue Shopping</a></div>
                        <div class="col"></div>
                        <div class="col"><a class="btn btn-danger" href="{{ url('delete_all_cart') }}">Clear Cart</a></div>
                        <div class="col"><a class="btn btn-info" href="">Update Cart</a></div>
                     </div>
                     {{-- {{ $card_items->links() }} --}}
